...
#include PRESENTATION_WAYPOINT_LIST  // "presentation/components/WaypointListPanel.h"로 자동 확장
#include <wx/msgdlg.h>
...
// 이벤트 테이블 매핑
wxBEGIN_EVENT_TABLE(presentation::components::WaypointListPanel, wxPanel)
    EVT_BUTTON(ID_ADD_WAYPOINT, presentation::components::WaypointListPanel::OnAddWaypoint)
    EVT_BUTTON(ID_REMOVE_WAYPOINT, presentation::components::WaypointListPanel::OnRemoveWaypoint)
    EVT_LIST_ITEM_SELECTED(ID_LIST_CTRL, presentation::components::WaypointListPanel::OnListItemSelected)
    EVT_LIST_ITEM_RIGHT_CLICK(ID_LIST_CTRL, presentation::components::WaypointListPanel::OnListItemRightClick)
    EVT_CHAR_HOOK(presentation::components::WaypointListPanel::OnKeyDown)
wxEND_EVENT_TABLE()
