...
class MapRenderPanel;
class RenderPipeline;

// Presentation layer forward declarations
...
private:
    ...
    presentation::components::MapOverlayHud* hudOverlay_{nullptr};        // wxPanel 상속 - HUD 오버레이
    presentation::components::NavigationProgressBar* progressBar_{nullptr}; // wxPanel 상속 - 진행률 표시
    presentation::components::WaypointListPanel* waypointPanel_{nullptr};   // wxPanel 상속 - 경유지 리스트
